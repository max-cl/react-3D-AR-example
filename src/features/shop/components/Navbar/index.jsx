    ...
    return (
        <nav id="header" className="top-0 z-30 w-full py-1">
            <div className="container flex flex-wrap items-center justify-between w-full px-6 py-3 mx-auto mt-0">
                <label className="block cursor-pointer md:hidden">
                    <svg
                ...
                <div className="flex items-center order-2 md:order-3" id="nav-content">
                    <a className="inline-block no-underline hover:text-black" href="#" aria-label="Check your profile">
                        <svg
                    ...
                    <a className="inline-block pl-3 no-underline hover:text-black" href="#" aria-label="Check the cart">
                        <svg
                            className="fill-current hover:text-black"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
